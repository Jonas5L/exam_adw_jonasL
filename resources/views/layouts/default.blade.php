...
<body class="flex flex-col min-h-screen bg-gray-100 lg:pl-0 pl-2">
    <nav class="bg-white border-gray-200 dark:bg-gray-900 dark:border-gray-700">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <a href="{{route('home')}}"  class="flex items-center space-x-3 rtl:space-x-reverse">
                ...
                {{-- asset('storage/img/corbais_logo.png' --}}
           ...
           <?php // break; ?> 
            <div class="hidden w-full md:block md:w-auto" id="navbar-dropdown">
                <ul
                    ...
                    <li>
                        <a href="{{route('home')}}"
                            class="block py-2 px-3 rounded md:bg-transparent md:p-0 md:dark:text-red-500 dark:bg-red-600 md:dark:bg-transparent {{ request()->is('/') ? 'text-red-700' : 'text-gray-400' }}"
                    ...
                    <li>
                        ...
                        <div id="dropdownNavbar"
                            ...
                            <ul class="py-2 text-sm text-gray-700 dark:text-gray-400"
                                ...
                                <li>
                                    <a href="{{route('service.geometry')}}"
                                        class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Géometrie</a>
                                </li>
                                <li>
                                    <a href="{{route('service.accessories')}}"
                                        class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Accessoires</a>
                                </li>
                                <li>
                                    <a href="{{route('service.dumper')}}"
                                        class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Amortisseurs, freins et échappements</a>
                                </li>
                                <li>
                                    <a href="{{route('service.conditions')}}"
                                        class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Conditions saisonnières, un gage de sécurité</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                    <li>
                        <a href="{{route('leasing.index')}}"
                            class="block py-2 px-3 text-gray-400 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-red-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent {{ request()->is('leasing') ? 'text-red-700' : 'text-gray-400' }}">Leasing</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="{{route('pricing.index')}}"
                            class="block py-2 px-3 text-gray-400 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-red-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent {{ request()->is('pricing') ? 'text-red-700' : 'text-gray-400' }}">Tarifs</a>
                    </li>
                    <li>
                        <a href="{{route('garage.index')}}"
                            class="block py-2 px-3 text-gray-400 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-red-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent {{ request()->is('garage') ? 'text-red-700' : 'text-gray-400' }}">Garage</a>
                    </li>
                    <li>
                        <a href="{{route('contact.index')}}"
                            class="block py-2 px-3 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-red-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent {{ request()->is('contact') ? 'text-red-700' : 'text-gray-400' }}">Contact</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="flex mt-4 flex-col lg:flex-row">
        <div class="flex-auto">
            <a href="#"
                ...
                <img class="object-cover w-full rounded-t-lg h-96 md:h-auto md:w-48 md:rounded-none md:rounded-s-lg"
                    src="{{asset('storage/img/contact.png')}}" alt="">
        ...
        <div class="flex-auto mx-6">
            ...
            <a href="#"
                ...
                <img class="object-cover w-full rounded-t-lg h-96 md:h-auto md:w-48 md:rounded-none md:rounded-s-lg"
                    src="{{asset('storage/img/badge-little-c.png')}}" alt="">
            </a>
    ...
    <div class="grid grid-cols-5 gap-4 mt-4">
        ...
        <div class="col-span-1">
            <a href="#" target="_blank">
                <img src="{{ asset('storage//partners/Bfgoodrich.png') }}" class="w-1/2" alt="Passion Pneu">
            </a>
        </div>
                <div class="col-span-1">
            <a href="#" target="_blank">
        ...
        <div class="col-span-1">
            <a href="#" target="_blank">
                <img src="{{ asset('storage//partners/Kleber.png') }}" class="w-1/2" alt="Passion Pneu">
            </a>
        </div>
        <div class="col-span-1">
            <a href="#" target="_blank">
      ...
      <div class="flex flex-row justify-around">
        <div>
            ...
            <ul class="text-gray-500 dark:text-gray-400 font-medium">
                ...
                <li class="mb-4">
                    <a href="" class="text-red-700 hover:text-red-900 hover:underline">Pneus</a>
                </li>
                <li class="mb-4">
                    <a href="#" class="text-red-700 hover:text-red-900 hover:underline">Géometrie</a>
                </li>
                <li class="mb-4">
                    <a href="#" class="text-red-700 hover:text-red-900 hover:underline">Jantes</a>
                </li>
                <li>
                    <a href="#" class="text-red-700 hover:text-red-900 hover:underline">Freins & échappement</a>
                </li>
                <li class="mb-4">
                    <a href="#" class="text-red-700 hover:text-red-900 hover:underline">Accessoires</a>
            </ul>
        </div>
        <div>
