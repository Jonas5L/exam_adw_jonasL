...
Route::get('/service.geometry/', [ServiceController::class, 'geometry'])->name('service.geometry');
Route::get('/service.accessories/', [ServiceController::class, 'accessories'])->name('service.accessories');
Route::get('/service.dumper/', [ServiceController::class, 'dumper'])->name('service.dumper');
Route::get('/service.conditions/', [ServiceController::class, 'conditions'])->name('service.conditions');
